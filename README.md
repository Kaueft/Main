...
<h3 align="center">IT Infrastructure & Cybersecurity Lead | Segurança, Infraestrutura e Automação</h3>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=2F81F7&center=true&vCenter=true&width=600&lines=IT+Infrastructure+%26+Cybersecurity+Lead;Automa%C3%A7%C3%A3o+%7C+Firewalls+%7C+SIEM+%7C+SOC;Construindo+uma+trajet%C3%B3ria+em+Cybersecurity" alt="Typing SVG" />
</p>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=Kaueft&label=Visitas+ao+perfil&color=2F81F7&style=flat" alt="Visitas ao perfil" />
</p>
...
- ☁️ Cloud Fundamentals, Administration and Solution Architect
- 🛡️ Cybersecurity
- 🕵️ Introdução ao Hacking e Pentest (Injeção de SQL, Nmap, Kali Linux, Shell Reversa)
- 🐧 Linux Fundamental
- 🌐 Bootcamp CCNA (camada de acesso, roteamento estático e dinâmico, serviços essenciais de rede, fundamentos de segurança, automação de redes)
- 🐧 Introdução ao Sistema Operacional Linux
- ☁️ Azure Cloud: criando um servidor com banco de dados para receber uma aplicação
- 🐍 Formação Python e Orientação a Objetos
- 🔐 Formação OWASP
- 🏗️ Gestão de Infraestrutura de TI
...
📝 Antes de commitar: confira se o link do LinkedIn acima abre corretamente
   (copie a URL exata da barra de endereço do seu perfil) e adicione aqui
   e-mail, portfólio ou certificações que queira destacar.
-->
